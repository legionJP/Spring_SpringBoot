...
5. [ JDBC Template](src/main/java/com/jspring6/springjdbcjp/repo/StudentRepo.java)

6. [JDBC Schema for H2DB  ](src/main/resources/schema.sql) , [Data Files](src/main/resources/data.sql)

7. [RowMapper for the Result Set ](src/main/java/com/jspring6/springjdbcjp/SchemaH2DB.java)

 - [implementation](src/main/java/com/jspring6/springjdbcjp/repo/StudentRepo.java)

8. [Spring JDBC Postgres]()